...
class PackageServiceProvider extends ServiceProvider
{
    ...
    {
        $this->loadViewsFrom(__DIR__.'/../Resources/views', 'm2de');
        $this->publishes([
            __DIR__.'/../Resources/views' => resource_path('views/vendor/m2de'),
        ]);
    }
    ...
    {
        $this->publishes([
            __DIR__.'/../Resources/assets/js' => resource_path('assets/js/vendor/m2de'),
        ], 'js');
    }
